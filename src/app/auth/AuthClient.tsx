...
function AuthContent() {
  ...
  const onLogin = async (data: LoginFormValues) => {
    ...
    try {
      ...
      if (res?.error) {
        toast.error(language === 'id' ? "Kredensial tidak valid. Silakan coba lagi." : "Invalid credentials. Please try again.");
      } else {
        toast.success(language === 'id' ? "Selamat datang kembali! Mengalihkan..." : "Welcome back! Redirecting...");
  ...
  const onRegister = async (data: RegisterFormValues) => {
    ...
    try {
      ...
      if (res.ok) {
        toast.success(language === 'id' ? "Akun berhasil dibuat! Menghubungkan..." : "Account created! Logging you in...");
        ...
        toast.error(errorData.message || (language === 'id' ? "Pendaftaran gagal." : "Registration failed."));
      }
    } catch (err) {
      toast.error(language === 'id' ? "Terjadi kesalahan saat pendaftaran." : "Something went wrong during registration.");
    } finally {
      setLoading(false);
    }
  };
