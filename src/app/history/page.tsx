  ...
  return (
    <div className="max-w-7xl mx-auto px-4 sm:px-6 py-16 sm:py-24 min-h-screen">
      <div className="mb-12 sm:mb-20 space-y-6">
        ...
        <h1 className="text-5xl sm:text-7xl md:text-8xl font-black text-foreground tracking-tighter leading-[0.9]">
          Analysis <span className="text-transparent bg-clip-text bg-gradient-to-br from-primary to-secondary">Vault</span>
        </h1>
        <p className="text-lg sm:text-xl md:text-2xl font-medium text-foreground/40 max-w-2xl leading-relaxed">
